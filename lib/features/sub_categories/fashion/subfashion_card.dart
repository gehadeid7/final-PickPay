...
class SubfashionCard extends StatefulWidget {
  final String imagePath;
  final String productName;
  final int index;
  final VoidCallback onTap;

  const SubfashionCard({
    super.key,
  ...
  @override
  State<SubfashionCard> createState() => _SubfashionCard();
}

class _SubfashionCard extends State<SubfashionCard>
