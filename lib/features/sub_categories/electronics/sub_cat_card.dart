...
class SubElectronicsCard extends StatefulWidget {
  final String imagePath;
  final String productName;
  final int index;
  final VoidCallback onTap;

  const SubElectronicsCard({
    super.key,
  ...
  @override
  State<SubElectronicsCard> createState() => _SubElectronicsCardState();
}

class _SubElectronicsCardState extends State<SubElectronicsCard>
