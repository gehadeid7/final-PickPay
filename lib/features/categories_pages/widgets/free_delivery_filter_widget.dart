...
class FreeDeliveryFilterWidget extends StatelessWidget {
  final String? selectedDeliveryType;
  final ValueChanged<String?> onDeliveryTypeChanged;

  const FreeDeliveryFilterWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final deliveryOptions = ['All', 'Free Delivery'];
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            items:
                deliveryOptions.map<DropdownMenuItem<String>>((String option) {
            ...
            onChanged: (String? newValue) {
              onDeliveryTypeChanged(newValue == 'All' ? null : newValue);
            },
            icon: Icon(
